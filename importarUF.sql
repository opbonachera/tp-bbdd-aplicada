...
BEGIN
    ...
    BEGIN TRY
        ...
        -- tabla temporal para carga inicial
        ...
        -- 3. Cargar datos desde el archivo
       
        BULK INSERT #ConsorciosTemp
        FROM 'C:\Users\Usuario\Desktop\TPBASEDDATOS' 
        WITH (
        ...
        PRINT  'Importación completada correctamente.'  + CAST(@Total AS NVARCHAR(10)) + ' registros insertados.';
    ...
    drop table #ConsorciosTemp;

END;


EXEC ddbba.ImportarConsorcios @RutaArchivo = 'C:\Users\Usuario\Desktop\TPBASEDDATOS';